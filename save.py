...
class VideoCameraSave(object):
    def __init__(self):
        ...
        self.face_cascade = cv2.CascadeClassifier('C:/Users/Surya/Downloads/project/haarcascade_frontalface_default.xml')
    ...
    def newMember(self, get_name):
        ...
        while True:
            for (x, y, w, h) in faces:
                ...
                flag = 0
            if flag == 0:
                cv2.imwrite("C:/Users/Surya/Downloads/project/images_db/" + img_name, detected_face)
